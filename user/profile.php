...
<body class="main" class="w3-light-grey">
    ...
    <div class="w3-white w3-text-grey w3-card-4" style="margin:auto; width:75%">
      ...
      <br>
        ...
        <p><i class="fa  fa-home fa-fw w3-margin-right w3-large w3-text-indigo"></i>  <?php
                       
                        echo $_SESSION['address'];

                        ?></p>
        
        <!-- <p><i class="fa fa-user fa-fw w3-margin-right w3-large w3-text-indigo"></i><?php echo $_SESSION['userid'] ?></p> -->
        <br><br>
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   <div class="form-group column col-6">
    ...
    <input type="text" class="form-control" id="text" placeholder="Eg.Paul" name="name" value="<?php echo $_SESSION['name']?>" disabled>
    <!-- <span class="text-danger fade show"><?php echo $password?></span> -->
  </div>

    <div class="form-group column col-6">
    <label for="text">Lastname:</label>
    <input type="text" class="form-control" id="text" name="lname" value="<?php echo $_SESSION['last']?>" disabled>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="pwd" value="<?php echo $_SESSION['number']?>" name="phone">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="pwd" value="<?php echo $_SESSION['address']?>" name="state">
    <span class="text-danger fade show"><?php echo $phonee;?></span>
  </div>
