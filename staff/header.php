...
<nav class="w3-sidebar w3-indigo w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:280px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a href="staff.php" class="w3-panel w3-bar-itemd  "><p class="navsize" class="w3-center">Dashboard <i class="nav-icon fas fa-tachometer-alt"></i></p></a>
...
if ($_SESSION['staffstatus']=="Manager") {
...
echo "<sup><b> $qry->num_rows </b></sup>";
  ...
  <a href="vieworders.php" class="navsize w3-bar-itemd my-button w3-leftbar w3-border-white"><i  class="fa fa-shipping-fast"></i>Outgoing package status </a> 
  <a href="vieworderscoming.php" class="navsize w3-bar-itemd my-button w3-leftbar w3-border-white"><i  class="fa fa-shipping-fast"></i>Incoming package status </a> 
...
<a href="assignedpackages.php" class="navsize w3-bar-itemd my-button w3-leftbar w3-border-white"><i  class="fa fa-shipping-fast"></i> Assigned Packages </a> 
...
?>
  ...
  <div style="color:white;border:none;">
   ...
   <a href="carinformation.php" class="navsize w3-bar-itemd my-button w3-leftbar w3-border-white "><i  class="fa fa-truck"></i> View Truck Information</a></div>
...
?>
  ...
  <a href="staffprofile.php" class="w3-panel w3-bar-itemd  ">My Profile <i  class="fa fa-user"></i></a>
 
<br><br><br>
<!-- LOGOUT BUTTON LINK -->
  <button  class="col-sm-4 btn btn-danger btn-flat btm w3-display-bottommiddle"  style="margin:auto"  data-toggle="modal" data-target="#logout"><i  class="fa fa-power-off"></i></button>
