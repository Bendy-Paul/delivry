...
<?php
                   ...
                   $destination=$delivery_info['delivery_state'];
					...
					$qry =$conn->query("SELECT * FROM d_orders WHERE delivery_truck_number='".$delivery_info['dcar_id']."' AND item_status!=8 AND  item_status!=9");
                    $status="";
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                 ...
                                 <div class="modal-body">
                                    <!-- item Tracking id -->
                                <div class="w3-card-2 card-primary  w3-padding-large w3-round w3-leftbar w3-border-indigo"><h4 class="fa  fa-address-card fa-fw fa-lg w3-margin-right w3-text-indigo"></h4><?php echo $row['tracking_number']?></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                     <br><br>
                                    <div class="w3-card-2 card-primary  w3-padding-large  w3-border w3-round w3-leftbar w3-border-indigo">
                                        ...
                                        <hr style="width:100%;">
                                        <!-- sender number -->
                                        <p><h6> <i class="fa  fa-user fa-fw fa-lg w3-margin-right w3-text-indigo"></i><?php echo $row['sender_number']; ?></h6></p>
                                        <hr style="width:100%;">
                                        <!-- sender address -->
                                        <p><h6> <i class="fa  fa-user fa-fw fa-lg w3-margin-right w3-text-indigo"></i><?php echo $row['sender_address']; ?></h6></p>
                                        <hr style="width:100%;">
                                     </div>
<br><br>      
                                    <div class="w3-card-2 card-primary  w3-padding-large  w3-border w3-round w3-leftbar w3-border-indigo">
                                        ...
                                        <hr style="width:100%;">
                                        <!-- reciver Number -->
                                        <p><h6><i class="fa  fa-user fa-fw fa-lg w3-margin-right w3-text-indigo"></i><?php echo $row['reciver_number']; ?></h6></p>
                                        <hr style="width:100%;">
                                        <!-- reciver addrass -->
                                        <p><h6> <i class="fa  fa-user fa-fw fa-lg w3-margin-right w3-text-indigo"></i><?php echo $row['reciver_address']; ?></h6></p>
                                        <hr style="width:100%;">
                                </div>
                            </div>

                             <div class="col-6"><br><br><div class="w3-card-2 card-primary  w3-padding-large  w3-border w3-round w3-leftbar w3-border-indigo">
...
<div class="icon2 w3-text-indigo w3-center">
    ...
    <h1>You Have Not Been Assigned To Any Package Yet</h1>
...
<div class="icon2 w3-text-indigo w3-center">
    ...
    <h1>You Have Not Been Assigned To A Delivery Truck Yet Try Again Later</h1>
