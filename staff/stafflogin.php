...
<?php 
include 'staffloginprocess.php';

// (isset( $_SESSION['loginsuccess'] ) and  $_SESSION['loginsuccess']  == true) ? header("location:staff.php"):'';
...
<form class="container form" method="POST"  action="stafflogin.php">
    <h1>Login</h1>
