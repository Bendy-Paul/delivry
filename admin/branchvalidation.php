...
if ($error==false && isset($_POST["submit"]) ) {
  ...
  $zip_code=rand(111111,99999999999);
  $check=$conn->query("SELECT * FROM office_branch WHERE branch_code='$zip_code'");
  if ($check->num_rows>0) {
    $zip_code=rand(11111,99999989);
  }
