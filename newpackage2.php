...
// ONLY DISPLAY IF USER DATA IS GOTTEN
if (($_GET['user']=="yes" AND $_SESSION['userid']!="")||$_GET['user']=="no" ) {
...
// PACKAGE RECIVER INFORMATION
    ...
    if (empty($_POST["name"])) {
      ...
      $fbranchid=$_POST["from"];
        ...
        $fbranchstate=$_POST["from"];
        $exts=explode(",",$fbranchstate);
         $fbranchstate=$exts[3];
         $fbranchstate = clean(strtolower($fbranchstate));
         $fbranchstate = str_replace('state','',$fbranchstate);
         $fbranchstate=str_replace(" ","",$fbranchstate);
         $fbranchstate=ucfirst($fbranchstate);
         echo "<br>".$fbranchstate;
...
echo  $_SESSION['userid']; ?>" disabled <?php
                } else {
                 echo '"';
        ...
        <div class="row" style="margin:auto">
          ...
          <div class="col-sm-6 " id="">
            ...
            <div class="form-group" id="fbi-field">
              ...
              <select name="from" id="from_branch_id" class="form-control select2" ="">
...
<!-- PACKAGE INFORMATION -->
       <div class="col-sm-6">
        ...
        <div class="col-sm-3">
              <b>Item Weight</b>
                       <div class="form-group">
                <input type="number" name="weight" id="" class="form-control" value="" required min="1" max="100000000000000">
        ...
        <div class="col-sm-3">
              <b>Item height</b>
              <div class="form-group">
              <input type="number" name="height" id="" class="form-control" value="" required min="1" max="100000000000000">
        ...
        <div class="col-sm-3">
              <b>Item Width</b>
              <div class="form-group">
              <input type="number" name="width" id="" class="form-control" value="" required min="1" max="100000000000000">
        ...
        <div class="col-sm-3">
              <b>Item Price</b>
                       <div class="form-group">
                <input type="number" name="price" oninput="myFunction()" id="fname" class="form-control" value="" required min="1" max="100000000000000">
...
function myFunction() {
  ...
  document.getElementById("total").innerHTML ="N0";
